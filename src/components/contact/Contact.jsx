...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Bhandara, Maharashtra 441904",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "saurabhwalde722@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 72XXXXXX60",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I’m actively looking for opportunities in Data Analysis, AI/ML, 
                and Prompt Engineering. Feel free to reach out if you’d like to 
                collaborate, discuss a project, or explore how I can contribute 
                to your team.
              </p>
            </div>
